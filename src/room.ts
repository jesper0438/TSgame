...
class Room {
     ...
     * @param login Login to computer
     * @param inloggen login virus
     */
    setExits(north : Room, east : Room, south : Room, west : Room, up : Room, down : Room, teleport : Room, login : Room, inloggen : Room,) : void {
        if(north != null) {
